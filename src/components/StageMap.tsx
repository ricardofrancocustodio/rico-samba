...
export function StageMap() {
  return (
    <svg
      ...
      role="img"
      aria-label="Mapa de palco: vocal e violão ao centro, percussão à direita, baixo à esquerda, retornos à frente e público abaixo."
    >
      <defs>
      ...
      <g>
        ...
        <text x="150" y="147" textAnchor="middle" fill="#F3E9CE" fontSize="14" fontFamily="Arial, sans-serif">Baixo</text>
        <text x="150" y="164" textAnchor="middle" fill="#D8C39A" fontSize="10" fontFamily="Arial, sans-serif" opacity="0.7">esquerda</text>
      </g>

      {/* Vocal/Violão - centro */}
      <g>
        <circle cx="320" cy="140" r="48" fill="#0E3B24" stroke="#E0A64B" strokeWidth="2" />
        <text x="320" y="135" textAnchor="middle" fill="#F3E9CE" fontSize="15" fontFamily="Arial, sans-serif">Vocal</text>
        <text x="320" y="153" textAnchor="middle" fill="#F3E9CE" fontSize="13" fontFamily="Arial, sans-serif">e Violão</text>
      </g>

      {/* Percussão - direita */}
      <g>
        <circle cx="490" cy="150" r="40" fill="#A85F2A" stroke="#C89A3C" strokeWidth="1.5" />
        <text x="490" y="147" textAnchor="middle" fill="#0E0B0A" fontSize="13" fontFamily="Arial, sans-serif" fontWeight="bold">Percussão</text>
        <text x="490" y="164" textAnchor="middle" fill="#1a0f09" fontSize="10" fontFamily="Arial, sans-serif">direita</text>
      </g>
